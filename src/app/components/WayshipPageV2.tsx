...
function StorytellingSection({ containerRef }: { containerRef: React.RefObject<HTMLDivElement> }) {
  ...
  // 15.5-second tab animation loop — runs while meetVisible is true
  const TOTAL_MS = 15500;
...
// ── Dispatch illustration (right panel of hero feature card) ─────────────
      ...
      <Wrap className="py-20 md:py-28">
        ...
        >
          <h2 className="text-[#1d1d1d] tracking-[-1.5px]" style={{ lineHeight: 1.1, fontSize: "clamp(28px, 3.2vw, 40px)" }}>
            <span style={{ fontFamily: "'TT Hoves Pro', sans-serif", fontWeight: 500 }}>Core Features, </span>
          ...
          >
            ...
            <div className="absolute left-[38px] top-[31px] z-10">
              <div className="inline-flex items-center gap-[10px] p-[10px] border border-[#ededed]" style={{ background: "#42ead4" }}>
                <span className="block w-2 h-2 rounded-full bg-[#103435]" />
                <p className="font-mono whitespace-nowrap" style={{ fontSize: 14, color: "#113637", fontWeight: 500 }}>DISPATCH</p>
              </div>
            </div>

            {/* Text content — bottom-left */}
            <div className="absolute left-[38px] z-10" style={{ bottom: 44, maxWidth: 440 }}>
              <p className="uppercase tracking-[0.18em] mb-2 text-[#abaca3]"
                style={{ fontFamily: "'TT Hoves Pro', sans-serif", fontWeight: 500, fontSize: 12 }}>
                New Feature
              </p>
              <h3 className="text-black mb-3" style={{ fontFamily: "'LT Cushion', serif", fontWeight: 300, fontSize: "clamp(20px, 2vw, 26px)", lineHeight: 1.25, letterSpacing: "-0.48px" }}>
                One list. Every party. Zero duplication.
              </h3>
              <p style={{ fontFamily: "'TT Hoves Pro', sans-serif", fontWeight: 400, fontSize: 16, color: "#85867b", lineHeight: 1.55 }}>
                Fill one comprehensive list. We handle the rest — routing the right information to every party that needs it, automatically.
              </p>
            </div>
